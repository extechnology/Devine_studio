...
const About = () => {
  ...
  const aboutBanner = banners?.find((banner) => banner.banner_type === "about");
  return (
    <div>
      <PageHeader
        title="About DivineStudio"
        ...
        image={aboutBanner?.image || "/home-interior.jpg"}
      />
      ...
      <section>
        <ScrollReveal className="mx-auto max-w-6xl py-8">
          <DirectorProfile />
        </ScrollReveal>
      </section>
        ...
        <ScrollReveal className="mx-auto grid max-w-6xl gap-10 px-6 md:grid-cols-[1fr_1.1fr]">
          <div className="glass-panel rounded-lg p-6 text-sm text-white/70 flex flex-col justify-center">
            ...
            <p className="mt-4">
              ...
              to meet the Divine Studio standard.
            </p>
          </div>
