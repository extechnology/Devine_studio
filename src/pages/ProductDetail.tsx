    ...
    <div className="bg-charcoal min-h-screen text-white font-body selection:bg-accent selection:text-white pb-20">
      ...
      <section>
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div className="w-full lg:w-1/2 flex flex-col p-8 sm:p-12">
              ...
              <div className="grid grid-cols-3  divide-x divide-white/20 border-t border-b border-white/20 py-6 text-center text-[11px] sm:text-xs font-heading tracking-widest uppercase bg-white/5">
                <div className="flex flex-col items-center justify-center px-2 hover:text-sand transition-colors">
                  <span className="font-bold text-sand mb-2 text-sm">100%</span>
                  <span className="text-white/60 text-xs">Customization</span>
                </div>
                <div className="flex flex-col items-center justify-center px-2 hover:text-sand transition-colors">
                ...
                <div className="flex flex-col items-center justify-center px-2 hover:text-sand transition-colors">
                  <span className="font-bold text-sand mb-2 text-sm">Fast</span>
                  <span className="text-white/60 text-xs">Delivery</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Product Description */}
          <div className="mb-24">
            <h3 className="text-xl font-heading mb-8 tracking-widest uppercase border-b border-white/10 pb-4 inline-block">
              Product Description
            </h3>
          ...
          <div>
            <div className="flex justify-between items-end mb-8 border-b border-white/10 pb-4">
              ...
              <Link
                to="/products"
                className="text-xs uppercase tracking-widest text-sand hover:text-white transition-colors"
              >
                View All →
              </Link>
            </div>
              ...
              {relatedProducts
                ...
                .map((related) => (
                  <Link
                    ...
                    key={related.id}
                    className="min-w-[280px] w-1/4 flex-shrink-0 snap-start bg-transparent border border-white/20 group hover:border-sand transition-all duration-300 block shadow-sm"
                  >
