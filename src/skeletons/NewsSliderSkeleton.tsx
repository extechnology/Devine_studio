          ...
          {[1, 2].map((idx) => (
            <div key={idx} className="group">
              <div className="relative overflow-hidden">
                <div className="w-full h-[300px] md:h-[380px] bg-gray-800"></div>
              </div>
              <div className="relative">
                <div className="absolute -top-20 left-5 w-[90%] bg-gray-700 p-6 shadow transform translate-y-6 z-10 min-h-[100px]">
